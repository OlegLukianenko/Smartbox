...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {2},
            new int[] {smartbox.test.application.R.layout.layout_snack_bar});
    ...
    private ActivitySplashBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (smartbox.test.application.databinding.LayoutSnackBarBinding) bindings[2]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.view == variableId) {
            ...
            setViewModel((smartbox.test.application.viewmodel.SplashActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable smartbox.test.application.viewmodel.SplashActivityViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeIncludeLayoutSnackBar((smartbox.test.application.databinding.LayoutSnackBarBinding) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeIncludeLayoutSnackBar(smartbox.test.application.databinding.LayoutSnackBarBinding IncludeLayoutSnackBar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        smartbox.test.application.viewmodel.SplashActivityViewModel viewModel = mViewModel;
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): includeLayoutSnackBar
        flag 2 (0x3L): view
