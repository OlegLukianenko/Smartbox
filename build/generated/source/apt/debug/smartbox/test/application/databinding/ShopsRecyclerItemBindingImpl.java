...
public class ShopsRecyclerItemBindingImpl extends ShopsRecyclerItemBinding implements smartbox.test.application.generated.callback.OnClickListener.Listener {
    ...
    public ShopsRecyclerItemBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ShopsRecyclerItemBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback4 = new smartbox.test.application.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((smartbox.test.application.app.home.adapter.ShopsRecyclerAdapter) variable);
        }
    ...
    public void setAdapter(@Nullable smartbox.test.application.app.home.adapter.ShopsRecyclerAdapter Adapter) {
    ...
    protected void executeBindings() {
        ...
        smartbox.test.application.app.home.adapter.ShopsRecyclerAdapter adapter = mAdapter;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        smartbox.test.application.app.home.adapter.ShopsRecyclerAdapter.UserItemListListener adapterUserItemListListener = null;
