...
public class FragmentEventsBindingImpl extends FragmentEventsBinding  {
    ...
    public FragmentEventsBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private FragmentEventsBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((smartbox.test.application.app.home.EventsFragment) variable);
        }
    ...
    public void setHandler(@Nullable smartbox.test.application.app.home.EventsFragment Handler) {
