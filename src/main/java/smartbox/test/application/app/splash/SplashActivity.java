package smartbox.test.application.app.splash;
...
import smartbox.test.application.base.BaseActivity;
import smartbox.test.application.databinding.ActivitySplashBinding;
import smartbox.test.application.utils.CheckInternetDialog;
import smartbox.test.application.utils.NetworkHelper;
import smartbox.test.application.viewmodel.SplashActivityViewModel;

import static smartbox.test.application.utils.Utils.collapse;
import static smartbox.test.application.utils.Utils.expand;
