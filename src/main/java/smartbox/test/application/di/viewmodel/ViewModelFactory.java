...
public class ViewModelFactory implements ViewModelProvider.Factory {
    ...
    public ViewModelFactory(ViewModelComponent component) {
        ...
        creators.put(EventsFragmentViewModel.class, component::eventsFragmentViewModel);
        creators.put(InformationFragmentViewModel.class, component::informationFragmentViewModel);
    }
